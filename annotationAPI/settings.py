...
CORS_ALLOWED_ORIGINS= [
    'http://MachinaCan.pythonanywhere.com',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'MachinaCan$default',        
        'USER': 'MachinaCan',    
        'PASSWORD': '#P9KZ9S4DB2dsXH', 
        'HOST': 'MachinaCan.mysql.pythonanywhere-services.com',         
        'PORT': '3306',
    }
}
